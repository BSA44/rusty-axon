...
fn main() {
    ...
    let purple_config = NetworkVisualizationConfig::with_colors(
        "lavender",
        "mediumpurple", // Input: light purple bg, medium purple neurons
        "mistyrose",
        "lightcoral", // Hidden: light pink bg, coral neurons
        "lightcyan",
        "lightskyblue", // Output: light cyan bg, sky blue neurons
    );
    mlp.visualize_network_with_config("network_purple", "png", &purple_config)
        .unwrap();
    ...
    let warm_config = NetworkVisualizationConfig::with_colors(
        "peachpuff",
        "lightsalmon", // Input: peach bg, salmon neurons
        "moccasin",
        "orange", // Hidden: moccasin bg, orange neurons
        "mistyrose",
        "indianred", // Output: misty rose bg, indian red neurons
    );

    let warm_config = warm_config.with_edges("red", 1.5);
    mlp.visualize_network_with_config("network_warm", "png", &warm_config)
        .unwrap();
    ...
    let cool_config = NetworkVisualizationConfig::with_colors(
        "lightcyan",
        "deepskyblue", // Input: light cyan bg, deep sky blue neurons
        "paleturquoise",
        "mediumturquoise", // Hidden: pale turquoise bg, medium turquoise neurons
        "lightgreen",
        "seagreen", // Output: light green bg, sea green neurons
    );
    mlp.visualize_network_with_config("network_cool", "png", &cool_config)
        .unwrap();
    ...
    let mono_config = NetworkVisualizationConfig::with_colors(
        "whitesmoke",
        "lightgray", // Input: whitesmoke bg, light gray neurons
        "gainsboro",
        "darkgray", // Hidden: gainsboro bg, dark gray neurons
        "silver",
        "gray", // Output: silver bg, gray neurons
    );
    mlp.visualize_network_with_config("network_mono", "png", &mono_config)
        .unwrap();
    ...
    let vibrant_config = NetworkVisualizationConfig::with_colors(
        "lightpink",
        "hotpink", // Input: light pink bg, hot pink neurons
        "khaki",
        "gold", // Hidden: khaki bg, gold neurons
        "palegreen",
        "limegreen", // Output: pale green bg, lime green neurons
    );
    mlp.visualize_network_with_config("network_vibrant", "png", &vibrant_config)
        .unwrap();
    ...
    mlp.visualize_network_with_config("network_custom_edges", "png", &edge_config)
        .unwrap();
    ...
    let professional_config = NetworkVisualizationConfig::with_colors(
        "ghostwhite",
        "steelblue", // Input: ghost white bg, steel blue neurons
        "floralwhite",
        "cadetblue", // Hidden: floral white bg, cadet blue neurons
        "ivory",
        "darkseagreen", // Output: ivory bg, dark sea green neurons
    )
    .with_edges("slategray", 0.8);
    mlp.visualize_network_with_config("network_professional", "png", &professional_config)
        .unwrap();
