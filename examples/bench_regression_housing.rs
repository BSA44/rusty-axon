...
fn main() {
    ...
    let mut wtr = Writer::from_path("python-tests/rusty-axon/regression-california-housing/rust_regression_metrics.csv").unwrap();
    ...
    wtr.flush().unwrap();
    println!("\nMetrics saved to: python-tests/rusty-axon/regression-california-housing/rust_regression_metrics.csv");
}
